...
(lib.CachedBmp_24 = function() {
	this.initialize(ss["avocado_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_13 = function() {
	this.initialize(ss["avocado_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.start,p:{scaleX:0.9999,scaleY:0.9999,x:250.3,y:11.2}}]}).to({state:[{t:this.shape_1},{t:this.start,p:{scaleX:1.1692,scaleY:1.1692,x:250.35,y:1.45}}]},1).to({state:[{t:this.shape_2},{t:this.start,p:{scaleX:1.0092,scaleY:1.0092,x:250.35,y:10.55}}]},1).to({state:[{t:this.shape_3},{t:this.start,p:{scaleX:1.0092,scaleY:1.0092,x:250.35,y:10.55}}]},1).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.text,p:{scaleX:0.9999,scaleY:0.9999,x:266.05,y:4.7}}]}).to({state:[{t:this.shape_1},{t:this.text,p:{scaleX:1.1438,scaleY:1.1438,x:265.95,y:-4.4}}]},1).to({state:[{t:this.shape_2},{t:this.text,p:{scaleX:0.9343,scaleY:0.9343,x:266.05,y:8.75}}]},1).to({state:[{t:this.shape_3},{t:this.text,p:{scaleX:0.9343,scaleY:0.9343,x:266.05,y:8.75}}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-38.3,-9.7,608.5999999999999,154.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(372.2,325.65,2.3517,2.3517,0,0,0,100.1,110);
	...
	this.shape_1.setTransform(1063.8967,300.4262,0.7014,0.693,0,0,8.8675);
...
// stage content:
(lib.avocado = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.texts.setTransform(371.8,325.2,1,1,0,0,0,371.8,325.2);
	this.texts.depth = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.texts).wait(204).to({regX:459,regY:284.1,scaleX:5.5918,scaleY:5.5918,x:371.9},0).wait(79).to({regX:490.5,regY:261.8,scaleX:4.235,scaleY:4.235,x:371.85,y:325.05},0).wait(50).to({regX:310.8,regY:277.8,scaleX:5.065,scaleY:5.065,x:372.05,y:325.2},0).wait(105).to({regX:391.5,regY:341.9,scaleX:1.0491,scaleY:1.0491,x:371.8,y:325.1},0).wait(196).to({regX:1022,regY:252.6,scaleX:4.27,scaleY:4.27,x:371.9,y:325.2},0).to({_off:true},1).wait(16));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/CachedBmp_9.png?1619187016203", id:"CachedBmp_9"},
		{src:"images/CachedBmp_8.png?1619187016203", id:"CachedBmp_8"},
		{src:"images/CachedBmp_5.png?1619187016203", id:"CachedBmp_5"},
		{src:"images/curtain.png?1619187016203", id:"curtain"},
		{src:"images/wasabi.png?1619187016203", id:"wasabi"},
		{src:"images/avocado_atlas_1.png?1619187015672", id:"avocado_atlas_1"},
		{src:"images/avocado_atlas_2.png?1619187015674", id:"avocado_atlas_2"},
		{src:"sounds/sound.mp3?1619187016203", id:"sound"}
	],
	preloads: []
};
